...
const FormularioGeneral = ({ tipoComunicacion = "NO LLEGO", setTipoComunicacion}) => {
	...
	const initialValues = {
		tituloInterno:'test noti aumento titulo interno',
		titulo: seleccionada.titulo ? seleccionada.titulo : 'test noti aumento titulo',
		fechaEnviar:getTodayDate(),
		fechaArchivar: '',
		contenidoComunicacion: seleccionada.msj ? seleccionada.msj : 'prueba noti aumento 332',
